...
Tables~\ref{tab:qual1}--\ref{tab:qual5} show model outputs for all five evaluation examples alongside verified ground-truth posts. All outputs are truncated to 220 characters for space; full outputs are available in the repository.

% ── Example 1: NYC Tax ────────────────────────────────────────────────────────
\begin{table}[H]
\centering
\caption{Example 1 — NYC Luxury Tax (Mamdani). Headlines: ``NYC Mayor Mamdani proposes \$500M luxury second-home tax''; ``Mamdani: We are taxing the rich.''}
\label{tab:qual1}
\begin{tabular}{lp{9.5cm}}
\toprule
\textbf{Model} & \textbf{Generated Post} \\
\midrule
Ground Truth  & ``Sadly, Mayor Mamdani is DESTROYING New York! It has no chance! The TAX, TAX, TAX Policies are SO WRONG. People are fleeing. They must change their ways, AND FAST. History has proven, THIS `STUFF' JUST DOESN'T WORK.'' \\
\midrule
...
RAG           & ``Governor Kathy Hochul of New York has Endorsed the `Liddle' Communist,' Zohran Mamdani, running for Mayor. This is a very bad development for New York City. Washington will be watching very closely.'' \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Example 2 --- Lebanon--Israel Ceasefire. Headlines: ``Israel and Lebanon hold first direct talks in 34 years''; ``US brokers 10-day ceasefire between Israel and Lebanon.''}
\label{tab:qual2}
\begin{tabular}{lp{9.5cm}}
\toprule
\textbf{Model} & \textbf{Generated Post} \\
\midrule
Ground Truth  & ``I just had excellent conversations with President Joseph Aoun of Lebanon and Prime Minister Netanyahu of Israel. They will begin a 10 Day CEASEFIRE at 5 P.M. EST. It has been my Honor to solve 9 Wars. GET IT DONE!'' \\
\midrule
...
Fine-tuned    & ``The United States and Israel are working closely together. One of the most important is the Peace Deal with the United Arab Emirates. This is a Major Breakthrough for Israel and the Middle East!'' \\
...
\begin{table}[H]
\centering
\caption{Example 3 --- Strait of Hormuz / China. Headlines: ``US military secures Strait of Hormuz amid Iran nuclear standoff''; ``Beijing agrees to halt weapons shipments to Iran.''}
\label{tab:qual3}
\begin{tabular}{lp{9.5cm}}
\toprule
\textbf{Model} & \textbf{Generated Post} \\
\midrule
Ground Truth  & ``China is very happy that I am permanently opening the Strait of Hormuz. They have agreed not to send weapons to Iran. President Xi will give me a big, fat, hug when I get there. BUT REMEMBER, we are very good at fighting!!!'' \\
\midrule
...
Fine-tuned    & ``The United States will continue to protect the free flow of oil and safety of the shipping lanes of the Strait of Hormuz. Iran has no reason to look at us in any other way than friendship, but we are very good at fighting if we have to.'' \\
...
\begin{table}[H]
\centering
\caption{Example 4 --- White House Ballroom / Judge. Headlines: ``Federal judge blocks White House ballroom construction''; ``DC court halts \$400M White House renovation funded by private donors.''}
\label{tab:qual4}
\begin{tabular}{lp{9.5cm}}
\toprule
\textbf{Model} & \textbf{Generated Post} \\
\midrule
Ground Truth  & ``A Trump Hating Judge wants Congress to pay Hundreds of Millions for a Glorious Ballroom, instead of accepting Donations from Great American Companies. The Ballroom is FREE to our Country, A GIFT, vital for National Security.'' \\
\midrule
...
Fine-tuned    & ``A Federal Judge in Washington has ruled that the Trump White House Ballroom will be built. This is a tremendous victory for the President and our Country. The cost of the restoration is being covered by private donation.'' \\
RAG           & ``Trump Administration decision is being blocked by a radical left judge. This is a total disgrace. We will fight this all the way to the Supreme Court!'' \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{table}[H]
\centering
\caption{Example 5 --- No Tax on Tips. Headlines: ``Trump heads to Las Vegas to rally for no-tax-on-tips legislation''; ``Senate Republicans advance bill to exempt tip income from federal taxes.''}
\label{tab:qual5}
\begin{tabular}{lp{9.5cm}}
\toprule
\textbf{Model} & \textbf{Generated Post} \\
\midrule
Ground Truth  & ``I'm on Air Force One heading to Las Vegas on NO TAX ON TIPS, a WINDFALL for our Great American Citizens. ALL THE COUNTRY DOES IS WIN. President DJT'' \\
\midrule
